            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-green-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/payment">
                  <div class="card-content text-white">
                    <h4 class="card-title">Staff Photo</h4>
                    <span>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-cyan-dark">
                <div class="card-statistic-3">
                  ...
                  <div class="card-content text-white">
                    <h4 class="card-title">Home photo</h4>
                    <span> </span>
                    <div class="progress mt-1 mb-1" data-height="8">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-purple-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/report">
                  <div class="card-content text-white">
                    <h4 class="card-title">Principal Photo</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
