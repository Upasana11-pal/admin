                <div id="main-wrapper" class="container" >
                    <div class="row">
                        <div class="col-md-11" style="margin-left:12%;margin-top:10%;background-color:white;">
                            <div class="panel panel-white">
                            	<div class="panel-heading clearfix">
                                    <h4 class="panel-title">Enter News Content</h4>
                                </div>
                            	...
                            	<?php $deta = $this->db->get("latestnews")->row();?>
                                   <form class="form-horizontal" action="<?php echo base_url()?>apanelForms/edit_news" method="post">
                                        <div class="form-group">
                                         ...
                                         <div class="col-sm-offset-2 col-sm-10"style="margin-left:10%;margin-top:20%;">
                    ...
                    <div class="row">
                        <div class="col-md-11" style="background-color:white; margin-left:12%;">
                            <div class="panel panel-white">
                            	<div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;margin-left:10%;">
                                            <tr>
                                                <th>#</th>
                                                <th>News</th>
                                                <th>Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<a href="<?php echo base_url();?>index.php/customer/deleteNews/<?php echo $row->id;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
