            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-green-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/schoolcontent">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-purple-dark">
                <div class="card-statistic-3">
                  ...
                  <div class="card-content text-white">
                    <h4 class="card-title">Send Free Reminder Sms</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
             ...
             <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-orange-dark">
                <div class="card-statistic-3">
                  ...
                  <div class="card-content text-white">
                    <h4 class="card-title">Send All Employee Sms</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
                      <div class="progress-bar 0-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-green-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                 <div class="card-content text-white">
                    <h4 class="card-title">Send Sms Parent And Employee</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
                      <div class="progress-bar 0-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-cyan-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                 <div class="card-content text-white">
                    <h4 class="card-title">Send All Parent Sms</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
                      <div class="progress-bar 0-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-purple-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                  <div class="card-content text-white">
                    <h4 class="card-title">Send Individual Notice</h4>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-orange-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                 <div class="card-content text-white">
                    <h4 class="card-title">Send To All</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
                      <div class="progress-bar 0-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100"></div>
             ...
             <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-green-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                  <div class="card-content text-white">
                    <h4 class="card-title">Send Class Wise Sms</h4>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-cyan-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/addemployee">
                   <div class="card-content text-white">
                    <h4 class="card-title">Send Transport Wise Sms</h4>
                    <span></span>
                    <div class="progress mt-1 mb-1" data-height="8">
                      <div class="progress-bar 0-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100"></div>
