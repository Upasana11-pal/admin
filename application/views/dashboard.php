            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-green-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/website">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-cyan-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/contactus">
                  <div class="card-content text-white">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-purple-dark">
                <div class="card-statistic-3">
                  ...
                  <div class="card-content text-white">
                    <h4 class="card-title">School Content</h4>
                    <span></span>
                    <div class="row">
                    <div class="col-md-6">
             ...
             <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-orange-dark">
                <div class="card-statistic-3">
                  ...
                  <a href="<?php echo base_url();?>index.php/login/sms">
                  <div class="card-content text-white">
                    ...
                    <span></span>
                     ...
                     <div class="row">
                    <div class="col-md-12">
                    <span>Send Sms Parent And Employee</span>
                    </div>
                    <div class="col-md-6">
                    <span></span>
                    </div>
                    ...
                    <div class="row">
                    <div class="col-md-12">
                    <span>Send Individual Notice</span>
                    </div>
                    <div class="col-md-6">
                    <span></span>
                    </div>
